		...
		<div class="row q-col-gutter-lg">
			<div class="col-12 col-sm-4">
				<div class="flex column justify-between items-center" style="min-height:300px;">
					...
					<div class="text-center">
						<q-btn type="a" color="accent" icon="fab fa-twitch" :href="twitchLoginLink">Login with Twitch</q-btn>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-sm-4">
				<div class="flex column justify-between items-center full-height" style="min-height:300px;">
					...
					<div class="text-center">
						<q-btn color="red-14" icon="fab fa-youtube">Login with youtube</q-btn>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-sm-4">
				<div class="flex column justify-between items-center full-height" style="min-height:300px;">
					...
					<div class="text-center">
						<q-btn color="blue-8" icon="fab fa-facebook-f">Login with Facebook</q-btn>
					</div>
				</div>
			</div>
		</div>
