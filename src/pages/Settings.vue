      ...
      >
        <template v-slot:before>
          ...
          >
            ...
            <q-tab name="accounts" icon="account_box" label="Accounts" style="justify-content:initial"/>
            ...
            <q-tab name="notifications" icon="notifications" label="Notifications" style="justify-content:initial"/>
            <q-tab name="connectivity" icon="cast_connected" label="Connectivity" style="justify-content:initial"/>
          </q-tabs>
        </template>
        <template v-slot:after>
          ...
          >
            <q-tab-panel name="accounts" style="min-width:500px" class="bg-transparent">
            ...
            <q-tab-panel name="appearance">
              ...
              <div class="q-pt-sm text-caption q-mb-md">THEME</div>
              <div>
                <q-item tag="label" v-ripple>
                  <q-item-section>
                    <q-item-label>Enable Dark Mode</q-item-label>
                    <q-item-label caption>Change the UI theme to light or dark mode.</q-item-label>
                  </q-item-section>
              ...
              <div class="q-pt-md text-caption q-mb-md">ADVANCED</div>
              <div>
                <q-item tag="label" v-ripple>
                  <q-item-section>
                    <q-item-label>Developer Mode</q-item-label>
                    <q-item-label caption>Developer mode exposes functionality helpful for debugging and extending the app.</q-item-label>
                  </q-item-section>
                  <q-item-section avatar>
            ...
            <q-tab-panel name="notifications">
              <div class="text-h5 q-mb-md">NOTIFICATIONS</div>
              <div class="q-pt-md text-caption q-mb-md">DEV MODE</div>
              <div>
                <q-item tag="label" v-ripple>
                  <q-item-section>
                    <q-item-label>Show badges for new log entries</q-item-label>
                    <q-item-label caption>Shows a badge when there is a new log entry.</q-item-label>
                  </q-item-section>
                  <q-item-section avatar>
            ...
            <q-tab-panel name="connectivity">
              <div class="q-pa-md text-h5 q-mb-md">CONNECTIVITY</div>
              <div>
                <q-item tag="label" v-ripple>
                  <q-item-section>
                    <q-item-label>Login automatically</q-item-label>
                    <q-item-label caption>If you have provided your authentication credentials in the 'MY ACCOUNT' section of the settings, you will be automatically logged in when the application starts.</q-item-label>
                  </q-item-section>
                  <q-item-section avatar>
